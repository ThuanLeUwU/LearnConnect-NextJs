    ...
    <div className="single-faq mb-8 w-full rounded-lg bg-[#eefbf3]">
      ...
      >
        ...
        <div className="w-full">
          <p
            className={`text-lg text-[#212832] text-[15px] font-medium ${
              active ? "text-[#309255]" : ""
            }`}
          >
            {header}
      ...
      >
        ...
        >
          <div className="w-3.5 h-3.5 bg-[#fff] rounded-full border-[3px] border-solid border-[#acd6bc] absolute top-[13px] left-[20px]"></div>
