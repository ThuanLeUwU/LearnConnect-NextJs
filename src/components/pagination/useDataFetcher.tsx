...
const useDataFetcher = (
  ...
  let API_URL = `https://learnconnectapi.azurewebsites.net/api/course/courses-with-favorite-and-filter?userId=${id}&currentPage=`;

  if (!id) {
    API_URL = `https://learnconnectapi.azurewebsites.net/api/course/get-courses-paging-with-filter?currentPage=`;
  }
