...
const LectureModeration = ({ params }: any) => {
  ...
  useEffect(() => {
    if (idCourse !== "") {
      try {
        http
          .get(
            `https://learnconnectapifpt.azurewebsites.net/api/content-moderation/get-moderation?lectureId=${LectureId}`
          )
          .then((res) => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      http
        .get(
          `https://learnconnectapifpt.azurewebsites.net/api/course/get-course-pending/${value}`
        )
        .then((response) => {
  ...
  const handleRejectClick = (data: any) => {
    ...
    try {
      http
        .post(
          `https://learnconnectapifpt.azurewebsites.net/api/lecture/process-lecture-request?lectureId=${LectureId}&acceptRequest=false&note=${data.reason}`,
          {
            headers: {
