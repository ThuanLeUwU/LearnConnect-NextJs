...
export default function ProfileUser({ params }: any) {
  ...
  let API_URL =
    "https://learnconnectapifpt.azurewebsites.net/api/course/get-courses-by-mentor?userId=";
  // if (isOwner) {
  //   API_URL =
  //     "https://learnconnectapifpt.azurewebsites.net/api/course/get-courses-by-mentorUserId?userId=";
  // }
    ...
    const fetchUserData = async () => {
      try {
        const response = await http.get(
          `https://learnconnectapifpt.azurewebsites.net/api/mentor/get-info/${idMentor}`
        );
  ...
  useEffect(() => {
    const fetchData = async () => {
      const responseData = await http.get(
        `https://learnconnectapifpt.azurewebsites.net/api/rating/listRatingOfMentor/${idMentor}`
      );
